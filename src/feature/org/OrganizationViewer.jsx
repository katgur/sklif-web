...
const schema = [
    ...
    },
    {
        text: "Администратор",
        tabs: [
            { name: "administratorFullName", text: "Имя" },
        ]
    },
    {
        text: "Контакты",
        tabs: [
            ...
            { name: "address", text: "Адрес" },
        ]
    },
];

function OrganizationViewer({ searchable }) {
